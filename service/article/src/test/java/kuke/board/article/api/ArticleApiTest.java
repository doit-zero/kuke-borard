...
public class ArticleApiTest {
    ...
    @Test
    void readTest(){
        ArticleResponse response = read(135745920646356992L);
        System.out.println("response: " + response);
    }
    ...
    void deleteTest(){
        restClient.delete()
                .uri("/v1/articles/{articleId}",135745920646356992L)
                .retrieve();
    }
    ...
    void countTest(){
        ...
        Long count1 = restClient.get()
                .uri("/v1/articles/{boardId}/count", 1L)
                .retrieve()
                .body(Long.class);
